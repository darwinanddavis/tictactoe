...
to setup
  ...
  ask n-of infected-patches patches [set pcolor brown]
  ;; create a hex grid of nodes
  ask n-of food-patches patches
  [
    sprout-nodes 1
    [
      set color green ;; dark gray
      set size 1.23
  ...
  create-walkers make-walkers [
    ask n-of 2 walkers [set color white]
    set color red
    set location one-of patches
    move-to location
  ]
